...
import { EchartsConsumptionChartContainer } from 'src/modules/MyConsumption/components/EchartsConsumptionChart/EchartsConsumptionChartContainer'
...
const echartsConsumptionChartContainerProps: EchartsConsumptionChartContainerProps = {
    filters: mockFilters,
...
describe('MyConsumptionContainer test', () => {
    test('onLoad getMetrics with isSolarProductionConsentOff false is called two times, one with default targets of autoconsumption and then all targets.', async () => {
        ...
        const { getByText } = reduxedRender(
            <Router>
                <EchartsConsumptionChartContainer {...echartsConsumptionChartContainerProps} />
            </Router>,
