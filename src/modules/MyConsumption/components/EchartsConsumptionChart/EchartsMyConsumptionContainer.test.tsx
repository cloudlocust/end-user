...
// Mock function to check the value of filters state in EchartsMyConsumptionContainer.
const mockSetFilters = jest.fn()
const FILTERS_TEXT = 'Filters'
// Mock function to check the value of range state in EchartsMyConsumptionContainer.
const mockSetRange = jest.fn()
const RANGE_TEXT = 'Range'
// Mock function to check the value of period state in EchartsMyConsumptionContainer.
...
// EchartsMyConsumptionContainer cannot render if we don't mock react-apexcharts
jest.mock(
    'src/modules/MyConsumption/components/EchartsConsumptionChart/EchartsConsumptionChartContainer',
    // eslint-disable-next-line jsdoc/require-jsdoc
    () => ({
        ...jest.requireActual(
            'src/modules/MyConsumption/components/EchartsConsumptionChart/EchartsConsumptionChartContainer',
        ...
        // eslint-disable-next-line jsdoc/require-jsdoc
        EchartsConsumptionChartContainer: (props: EchartsConsumptionChartContainerProps) => (
            <div>
...
describe('EchartsMyConsumptionContainer test', () => {
