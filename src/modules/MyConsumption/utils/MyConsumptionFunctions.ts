...
export const isEqualDates = (date1: number, date2: number, period: periodType) => {
    if (period === 'daily')
        return dayjs(new Date(date1)).format('D/M/YY-HH:mm') === dayjs(new Date(date2)).format('D/M/YY-HH:mm')
    else if (period === 'yearly')
        return dayjs(new Date(date1)).format('MM/YYYY') === dayjs(new Date(date2)).format('MM/YYYY')
    return dayjs(new Date(date1)).format('DD/MM/YYYY') === dayjs(new Date(date2)).format('DD/MM/YYYY')
}
