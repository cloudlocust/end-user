...
import 'src/modules/Analysis/components/EchartsAnalysisChart/EchartsAnalysisChart.scss'
import { IMetric } from 'src/modules/Metrics/Metrics.d'
import TypographyFormatMessage from 'src/common/ui-kit/components/TypographyFormatMessage/TypographyFormatMessage'

import { convertMetricsDataToApexChartsAxisValues } from 'src/modules/MyConsumption/utils/apexChartsDataConverter'
import ReactECharts from 'echarts-for-react'
import { getEchartsAnalysisChartOptions } from './echartsAnalysisChartOptions'
...
export default React.memo(EchartsAnalysisChart, (prevProps, nextProps) => prevProps.data === nextProps.data)
