...
describe('AnalysisPercentageChangeArrows test', () => {
    test('when data given, it should render all information', async () => {
        const { getByText } = reduxedRender(<AnalysisPercentageChangeArrows {...mockAnalysisPercentageChangeArrows} />)
    ...
    test('when isMetricsLoading, no data available should be shown', async () => {
        ...
        const { container } = reduxedRender(<AnalysisPercentageChangeArrows {...mockAnalysisPercentageChangeArrows} />)
