...
import { isBowattsNrLinkForm, isPopupAfterRegistration } from 'src/modules/User/Register/RegisterConfig'
                ...
                <motion.div initial={{ opacity: 0, scale: 0.6 }} animate={{ opacity: 1, scale: 1 }}>
                    <Card className="w-full max-w-384">
                        <CardContent className="flex flex-col items-center justify-center p-16 sm:p-24 md:p-32">
                            ...
                            <Typography
                                variant="h6"
                                className="mt-16 mb-24 font-semibold text-18 sm:text-24 text-center"
                            >
                                {isBowattsNrLinkForm
                                    ? formatMessage({
                                          id: 'Formulaire BôWatts-nrLINK pour obtenir son estimation chez notre fournisseur Alpiq',
                                          defaultMessage:
                                              'Formulaire BôWatts-nrLINK pour obtenir son estimation chez notre fournisseur Alpiq',
                                      })
                            ...
                            {isNoticeShown && (
                                <TypographyFormatMessage className="text-13 mb-32 text-center font-medium">
                                    {isBowattsNrLinkForm
                                        ? 'Formulaire sans engagement de souscription'
