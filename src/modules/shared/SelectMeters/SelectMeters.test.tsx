...
import { SelectMeters } from 'src/modules/MyConsumption'
...
describe('Test SelectMeters', () => {
    test('Сhecking active field change in select', async () => {
        mockMeterList = TEST_METERS
        const { getByText } = reduxedRender(
            <SelectMeters handleOnChange={mockhandleOnChange} inputColor="red" metersList={mockMeterList} />,
        )
